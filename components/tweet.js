  ...
  return (
    ...
    >
      ...
      <div className="flex justify-around space-x-5">
        <div onClick={replyTweet} className="my-2 rounded-lg bg-slate-600 p-2">
          Replies: <span>{tweet.replies.length}</span>
        </div>
        <div onClick={likeTweet} className="my-2 rounded-lg bg-slate-600 p-2">
          Like: 0 (Coming Soon)
        </div>
        <div onClick={editTweet} className="my-2 rounded-lg bg-slate-600 p-2">
          Edit
        </div>
        <div
          onClick={deleteTweet}
